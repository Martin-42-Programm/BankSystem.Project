...
{
    /// <inheritdoc />
    public partial class CreditsResolving5 : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Status = table.Column<string>(type: "longtext", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    DesiredRepaymentTerm = table.Column<DateTime>(type: "datetime(6)", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Credits_AspNetUsers_CreatedById",
                        column: x => x.CreatedById,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Credits_AspNetUsers_DeletedById",
                        column: x => x.DeletedById,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Credits_AspNetUsers_ModifiedById",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Credits_CreatedById",
                table: "Credits",
                column: "CreatedById");

            migrationBuilder.CreateIndex(
                name: "IX_Credits_DeletedById",
                table: "Credits",
                column: "DeletedById");

            migrationBuilder.CreateIndex(
                name: "IX_Credits_ModifiedById",
                table: "Credits",
                column: "ModifiedById");
